document.getElementById('loginForm').addEventListener('submit', function(event) {
    ...
    const users = {
        ...
        'hafizatunnafisah': { password: 'hfzatunn032', link: 'https://edisamsuar.github.io/salam-hfz' },
        'nurulalfalah': { password: 'nrlalfalah356', link: 'https://edisamsuar.github.io/salam-nrl' },
    ...
    if (users[username] && users[username].password === password) {
        ...
        alert('Username atau password salah! Cube Ketik Ulang');
    }
});
